...
**Authors**: Pablo Rosa,  <a href="https://scholar.google.com/citations?user=2gugaZIAAAAJ&hl=es">Cristina Borra</a>
...
- **Gender Gaps in Reaction to Reward-Only Incentives**
  
**Authors**: Pablo Rosa, <a href="https://scholar.google.com/citations?user=2gugaZIAAAAJ&hl=es">Cristina Borra</a>, and <a href="https://scholar.google.com/citations?user=_-9c_UoAAAAJ&hl=es">Pilar Cuevas-Ruíz</a>

**Abstract**: We study how increasing positive-only incentives in a real-world, high-stakes setting affects gender gaps in performance. We exploit a 2016 reform of Spain's university entrance examination that let a strong Mathematics grade count twice toward the admission score, raising the returns to excelling without changing the penalty for poor performance. Using administrative data on science-track students in Andalusia (2010--2018) and a difference-in-differences design, we find the reform widened the gender gap by about 0.07 standard deviations, driven by a relative decline in female performance. The effect is concentrated in Technological Sciences, where the reform raised incentives, and absent in Health Sciences, where the incentive weights were unchanged. This heterogeneity points to incentive intensity, not selection, as the mechanism. Unlike in laboratory settings, where reward-only incentives leave the gender gap unchanged, such incentives widen it once real stakes are involved, even when they reward success without penalizing failure.
